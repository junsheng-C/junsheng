...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'photo', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'uneichen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '不普通的普通人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://unie.eu.org', // 网站地址
