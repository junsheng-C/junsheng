...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'unieChen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Menu', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'unie.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Design, 设计, 生活, 意义', // 网站关键词 英文逗号隔开
